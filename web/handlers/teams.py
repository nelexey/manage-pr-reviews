...
from database.methods.team import create_team, check_team_exists, get_team_with_members
...
async def get_team(team_name: str, session: DbSession):
    ...
    members = [{"user_id": u.user_id, "username": u.username, "is_active": u.is_active} for u in users]
