...
class PullRequest(Base):
    ...
    author_id: Mapped[str] = mapped_column(String, ForeignKey("users.user_id", ondelete="CASCADE"), nullable=False)
    status: Mapped[str] = mapped_column(String, default=PRStatus.OPEN.value, nullable=False)
    assigned_reviewers: Mapped[list[str]] = mapped_column(ARRAY(String), default=list, nullable=False)
